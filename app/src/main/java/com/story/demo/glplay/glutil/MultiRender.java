...
public class MultiRender implements PEGLSurfaceView.PGLRender {
    ...
    public void setTextureId(int textureId, int index) {
        Log.e(TAG, "setTextureId index : " + index + " textureId : " + textureId);
    ...
    public void onSurfaceCreate() {
        ...
        Log.e(TAG, "index : " + index + " textureId : " + textureId);
        if (index == 0) {
